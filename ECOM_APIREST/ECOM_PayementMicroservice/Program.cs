        ...
        public static void Main(string[] args)
        {
            ...
            .AddJwtBearer(options =>
            {
                var key = Encoding.UTF8.GetBytes(builder.Configuration["Jwt:SecretKey"] ?? 
                    "ECOM_tp_suPer_Secret_Key_For_JWT_Auth_2024");
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ECOM Payment API", Version = "v1" });
            ...
            if (app.Environment.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ECOM Payment API V1");
